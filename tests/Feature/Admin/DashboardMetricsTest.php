...
use App\Livewire\Dashboard\Orders as OrdersDashboard;
use App\Livewire\Dashboard\Sales as SalesDashboard;
...
it('provides actionable sales insights and supports resetting preferences', function () {
    ...
    $component = Livewire::test(SalesDashboard::class);
...
it('provides actionable order fulfillment insights and status/recent-order summaries', function () {
    $user = User::factory()->create();
    actingAs($user);
    ...
    // Enough pending orders to push the pending percentage past the
    // 35% threshold that triggers the "Fulfillment Focus" insight.
    $firstOrder = Order::create([
        'customer_name' => 'Jane Doe',
        'customer_email' => 'jane@example.com',
        'customer_phone' => '01700000000',
    ...
    $component = Livewire::test(OrdersDashboard::class);
