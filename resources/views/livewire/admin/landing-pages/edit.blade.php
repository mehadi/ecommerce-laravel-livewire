<div class="w-full space-y-8">
    <div class="flex flex-wrap items-start justify-between gap-4">
        <div class="space-y-1">
            ...
            <flux:text size="sm" variant="subtle">
                {{ __('Update your landing page configuration, sections, and settings.') }}
            </flux:text>
        </div>
    ...
    <form wire:submit="update" class="space-y-8">
        <section class="space-y-6 rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
            ...
            {{-- Live Preview Link --}}
            @if($landingPage->is_active && $slug)
                <div class="rounded-lg border border-emerald-200 bg-emerald-50/50 p-4 dark:border-emerald-800 dark:bg-emerald-900/20">
        ...
        <div class="flex items-center justify-between gap-4 rounded-lg border border-zinc-200 bg-zinc-50/50 p-4 dark:border-zinc-700 dark:bg-zinc-800/50">
            <div class="text-sm text-zinc-600 dark:text-zinc-400">
                <p class="font-medium">{{ __('Ready to update your landing page?') }}</p>
                <p class="text-xs">{{ __('Review your changes and click the button below to save') }}</p>
            </div>
