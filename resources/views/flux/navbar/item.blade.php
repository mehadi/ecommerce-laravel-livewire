...
$classes = Flux::classes()
    ->add('px-3 h-9 flex shrink-0 items-center rounded-lg transition-colors duration-150')
    ...
    ->add('data-current:after:absolute data-current:after:-bottom-3 data-current:after:inset-x-0 data-current:after:h-[2px] data-current:after:rounded-full data-current:after:transition-colors data-current:after:duration-150')
    ->add([
    ...
    ->add(match ($accent) {
        true => [
            ...
            'data-current:text-emerald-700 dark:data-current:text-emerald-400 data-current:font-semibold hover:data-current:text-emerald-700 dark:hover:data-current:text-emerald-400 hover:bg-zinc-800/5 dark:hover:bg-white/10 hover:data-current:bg-emerald-500/10 dark:hover:data-current:bg-emerald-400/10',
            'data-current:after:bg-emerald-500',
        ],
        false => [
            'hover:text-zinc-800 dark:hover:text-white',
