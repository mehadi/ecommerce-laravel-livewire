@php
    ...
    $faqs = [
        [
            'question' => __('What is :name?', ['name' => $siteName]),
            'answer' => __('It\'s a platform for building and running your own online store — landing pages, product catalog, checkout, and admin tools included, without writing code.'),
        ],
        [
            'question' => __('Do I need a credit card to start?'),
            'answer' => __('No. The Starter plan is free — you can create your account and start setting up your store right away.'),
        ],
        [
            'question' => __('Can I use my own custom domain?'),
            'answer' => __('Yes, on paid plans. Point your domain at your store and we handle verification and certificates automatically.'),
        ],
        [
            'question' => __('Can I change plans later?'),
            'answer' => __('Yes, you can upgrade at any time as your catalog and team grow — your store and data stay exactly as they are.'),
        ],
        [
            'question' => __('Is my store\'s data isolated from other stores?'),
            'answer' => __('Yes. Every store runs on its own isolated tenant — your products, orders, and settings are never shared with or visible to other stores on the platform.'),
        ],
        [
            'question' => __('What support do you offer?'),
            'answer' => __('Every plan includes access to our support team to help you get set up and keep your store running smoothly.'),
        ],
    ];
@endphp
                    ...
                    <div x-data="{ isOpen: {{ $index === 0 ? 'true' : 'false' }} }">
                        <h3>
                            <button
                                ...
                                aria-controls="platform-faq-panel-{{ $index }}"
                        ...
                        <div
                            x-show="isOpen"
                            x-collapse
                            id="platform-faq-panel-{{ $index }}"
                            role="region"
                            aria-labelledby="platform-faq-button-{{ $index }}"
                        >
