<a
    ...
    class="w-full px-4 py-3 rounded-full bg-red-500 text-white shadow-[0_4px_12px_-2px_rgb(239_68_68_/_0.5)] hover:bg-red-600 transition-colors duration-200 flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-zinc-900"
    aria-label="{{ __('Customer reviews') }}"
>
    ...
    <span class="text-sm font-bold">{{ __('Reviews') }}</span>
</a>
