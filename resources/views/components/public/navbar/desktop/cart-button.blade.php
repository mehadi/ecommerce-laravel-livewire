...
>
    ...
    <span
        ...
        style="display: none"
        class="absolute -top-1 -right-1 flex items-center justify-center min-w-[19px] h-[19px] px-1 rounded-full bg-red-500 text-[10px] font-bold text-white ring-2 ring-white dark:ring-zinc-900 tabular-nums"
    ></span>
</button>
