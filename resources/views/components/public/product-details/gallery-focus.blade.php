{{-- Gallery Focus product-details content — larger image, vertical thumbnail rail, stronger hover zoom. --}}
<div class="grid md:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] gap-10 md:gap-14 lg:gap-16 items-start">
    <div class="md:sticky md:top-24">
        @include('components.public.product-details._gallery', [
            'product' => $product,
            'thumbLayout' => 'rail',
            'zoom' => true,
            'mainAspect' => 'aspect-[4/5]',
        ])
    </div>
